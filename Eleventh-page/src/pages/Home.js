              ...
              <div className={styles.assessment}>
                <div className={styles.menuParent}>
                  <img
                    ...
                    src="../menu1.svg"
                  />
                  <div className={styles.brief}>Requirements</div>
                </div>
              </div>
              <div className={styles.assessment}>
                <div className={styles.menuParent}>
                  <img
                    ...
                    src="../menu1.svg"
                  />
                  <div className={styles.brief}>Milestones</div>
                </div>
              </div>
              <div className={styles.assessment3}>
                <div className={styles.menuParent}>
                  <img
                    ...
                    src="../addsquare.svg"
                  />
                  <div className={styles.brief}>Add More</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.assessment4}>
          <div className={styles.menuParent}>
            <img
              ...
              src="../additem.svg"
            />
            <div className={styles.brief}>Add Chapter</div>
          </div>
        </div>
      </div>
      <div className={styles.content}>
        <div className={styles.briefParent}>
          <div className={styles.brief1}>Brief</div>
        ...
        <div className={styles.briefParent}>
          <div className={styles.brief1}>Requirements</div>
          <div className={styles.textField}>
            <div className={styles.text6}>Description</div>
            <img
              className={styles.icons16pxarrowDownFilled}
        ...
        <div className={styles.briefParent}>
          <div className={styles.brief1}>Milestones</div>
          <div className={styles.textField}>
            <div className={styles.text6}>Description</div>
            <img
              className={styles.icons16pxarrowDownFilled}
