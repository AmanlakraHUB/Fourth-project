              ...
              <div className={styles.assessment}>
                <div className={styles.menuParent}>
                  <img
                    ...
                    src="../menu3.svg"
                  />
                  <div className={styles.curatedResources}>
                    Curated Resources
                  </div>
                </div>
              </div>
              <div className={styles.assessment}>
                <div className={styles.menuParent}>
                  <img
                    ...
                    src="../menu3.svg"
                  />
                  <div className={styles.curatedResources}>Events</div>
                </div>
              </div>
              <div className={styles.assessment2}>
                <div className={styles.menuParent}>
                  <img
                    ...
                    src="../addsquare.svg"
                  />
                  <div className={styles.curatedResources}>Add More</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.assessment3}>
          <div className={styles.menuParent}>
            <img
              ...
              src="../additem.svg"
            />
            <div className={styles.curatedResources}>Add Chapter</div>
          </div>
        </div>
      </div>
      <div className={styles.content}>
        <div className={styles.curatedResourcesParent}>
          <div className={styles.curatedResources1}>Curated Resources</div>
        ...
        <div className={styles.curatedResourcesParent}>
          <div className={styles.curatedResources1}>Events</div>
          <div className={styles.textField}>
            <div className={styles.text6}>Description</div>
            <img
              className={styles.icons16pxarrowDownFilled}
